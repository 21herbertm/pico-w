...
#include "/Users/mherbert/pico-sdk/lib/btstack/port/stm32-f4discovery-cc256x/Inc/spi.h"
...
void ConfigCam(void)
{
    ...
    tx[0] = 0x01;
    tx[1] = 0x80;
    i2c_write_blocking(hi2c1, 0xff, tx, 1, false);
    i2c_write_blocking(hi2c1, 0x12, tx, 1, false);
    tx[0] = 0x01;
    tx[1] = 0x00;
    i2c_write_blocking(hi2c1, OV5640_5MP_JPEG);
    write_sensor_reg(hi2c1, OV2640_YUV422);
    write_sensor_reg(hi2c1, OV2640_JPEG);
    i2c_write_blocking(hi2c1, 0xff, tx, 1, false);
    i2c_write_blocking(hi2c1, 0x15, tx, 1, false);
